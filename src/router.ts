...
const routes = [
  ...
  { path: '/partners', components: {default:partnersPage, header:Header}  },
  { path: '/partners/:id', components: {default:partnerDetailPage, header:Header}  },
  { path: '/order-shipments', components: {default:shipmentsPage, header:Header}  },
