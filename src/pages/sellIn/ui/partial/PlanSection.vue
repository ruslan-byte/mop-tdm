    ...
    <div class="g-white-block py-8 px-6">
        ...
        >
            ...
            <div class="flex flex-col items-end">
                ...
                <PlanDatePicker v-model="datePickerData"></PlanDatePicker>
            </div>
        </div>
...
import { PlanDatePicker } from '@/entities/partner'
...
const quartalsData: IQuartalBlockData[] = [
    {
        quartal: '1',
        factSum: 15036000,
        planSum: 30000000,
        totalFactPercent: 50.12,
        electroSum: 9773400,
        kppSum: 5262600,
        reletedPercentElectro: 65,
        reletedPercentKpp: 35,
        dynamicPercent: 12
    },
    {
        quartal: '2',
